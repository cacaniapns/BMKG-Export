    ...
    if (!in_array($post_type, $valid_types) || empty($date)) {
        ...
        try {
            ...
            if ($post_type === 'temperature') {
                ...
                $col_name = "`" . $hour . ":00`";
                $mysqli->query("UPDATE temperature_data SET $col_name = NULL WHERE id_temperature = '$daily_id'");
                ...
                $col_name = "`" . $hour . ":00`";
                $mysqli->query("UPDATE humidity_data SET $col_name = NULL WHERE id_humidity = '$daily_id'");
